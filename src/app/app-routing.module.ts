...
import { NOT_FOUND, ROUTING_AUTH, ROUTING_CONFIRM_PHONE, ROUTING_FORBIDDEN, ROUTING_FORGOT_PASSWORD, ROUTING_MANAGE_TEMPLATES, ROUTING_CONFIRMATION, ROUTING_RESET_PASSWORD, ROUTING_VERIFY_PHONE, SERVER_ERROR } from './app.constants';
...
const routes: Routes = [
  ...
  { path: ROUTING_RESET_PASSWORD, component: ResetPasswordComponent,
    children: [
      {path: 'confirmed', component:ResetConfirmationComponent}
    ] 
  },
  { path: 'password-confirmed', component: ResetConfirmationComponent},
